...
1. **CHOP:** The path to the source CHOP you want to pull data from.
   ...
   - *Tip:* You can drag and drop a source CHOP directly onto the Select CHOP to automatically fill this parameter.
2. **Channel Names:** The specific channel(s) you want to extract.
   ...
   - *Tip:* Use the dropdown arrow next to the parameter to see a list of available channels from the source CHOP.
