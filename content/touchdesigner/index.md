...
| Page                                                                                           | Description                         |
| ---------------------------------------------------------------------------------------------- | ----------------------------------- |
| [[touchdesigner/01_Core_Concepts/index|(y) Index: Core Concepts]]                                | Chapter hub                         |
...
| Family                                                     | Role                                  |
| ---------------------------------------------------------- | ------------------------------------- |
| [[touchdesigner/02_The_Operators/index|(y) Index: The Operators]]                               | Chapter hub                         |
...
| Page                                                                                  | Description                                |
| ------------------------------------------------------------------------------------- | ------------------------------------------ |
| [[touchdesigner/03_Rendering_and_Output/index|(y) Index: Rendering & Output]]                       | Chapter hub                         |
...
| Page                                                                                                    | Description                         |
| ------------------------------------------------------------------------------------------------------- | ----------------------------------- |
| [[touchdesigner/04_Scripting_and_Architecture/index|(y) Index: Scripting & Architecture]]                 | Chapter hub                         |
...
| Page                                                                                          | Description                            |
| --------------------------------------------------------------------------------------------- | -------------------------------------- |
| [[touchdesigner/05_Connectivity_and_Shaders/index|(y) Index: Connectivity & Shaders]]                   | Chapter hub                         |
...
| Page                                                                                                                                       | Description                                                                                                 |
| ------------------------------------------------------------------------------------------------------------------------------------------ | ----------------------------------------------------------------------------------------------------------- |
| [[touchdesigner/06_Recipes_and_Projects/index|(y) Index: Recipes & Projects]]                               | Chapter hub                         |
...
| [[touchdesigner/06_Recipes_and_Projects/Real-time Audio Visualizer\|(y-) Real-time Audio Visualizer with FFT and Instancing]]              | Professional audio visualizer using Audio Spectrum CHOP, FFT analysis, and geometry instancing              |
| [[touchdesigner/06_Recipes_and_Projects/GPU Fluid Simulation\|(y-) GPU Fluid Simulation with Feedback TOPs]]                               | Real-time GPU-accelerated fluid simulation using Feedback TOP system for velocity and density fields        |
| [[touchdesigner/06_Recipes_and_Projects/Instanced 3D Models with PBR\|(y-) Instanced 3D Models with PBR Materials]]                        | Efficiently render thousands of 3D models using instancing with Physically Based Rendering (PBR) materials  |
| [[touchdesigner/06_Recipes_and_Projects/Real-time Motion History and Optical Flow\|(y-) Real-time Motion History Images and Optical Flow]] | Motion analysis using Motion History Images (MHI) and Optical Flow techniques for interactive installations |
