---
title: Splits & Kick-Height Progression
tags:
  - taekwondo
  - stretching
  - flexibility
...
The [[notes/taekwondo/stretching|(y-) stretching page]] covers the daily mobility routine and the science of when to stretch. This page is the specific project: getting the front and side splits so head-height and spinning kicks actually have the range they need. It is a structured, patient program, not a party trick you force in a week.

Flexibility is a strength quality, not just a passive one. You do not want a leg that flops to head height; you want one that gets there under control and holds. This program trains both.
...
- **Breathe out to go deeper.** A long exhale signals the brain that the position is safe and releases another inch. Sink on the breath out, hold on the breath in.

---

## (y-) The PNF Engine (Contract-Relax)

Proprioceptive Neuromuscular Facilitation is the fastest route to new range. It uses your own muscle contraction to trick the nervous system into permitting a deeper stretch.

1. Ease into the stretch to a comfortable but real limit.
2. **Contract** the stretched muscle against resistance (the floor, a wall, a partner) at 50 to 70% effort for **6 to 10 seconds**.
3. **Relax**, exhale, and immediately sink into a noticeably deeper stretch. Hold **20 to 30 seconds**.
4. Repeat 3 to 4 rounds. Expect a small, real gain each session.

---

## (y-) A 12-Week Structure
...
- **Elevated splits.** Once flat splits are close, put the front or rear foot on a low block to build strength past your current floor range.

---

## (y-) Recovery and Consistency

- **Do not max out every day.** Alternate deep PNF days with lighter mobility days so tissue recovers.
...
- [Science of Taekwondo (Academic Studies)](https://www.google.com/search?q=taekwondo+flexibility+PNF+studies)
