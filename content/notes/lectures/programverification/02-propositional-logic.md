...
- A **satisfiable** formula is one that _can_ be true; a **valid** formula is one that _must_ be true (no matter what).
...
- **Satisfiable**: There exists _at least one_ assignment that makes the formula true.
- **Valid (Tautology)**: _Every_ possible assignment makes the formula true.
- **Unsatisfiable (Contradiction)**: _No_ assignment makes it true.
