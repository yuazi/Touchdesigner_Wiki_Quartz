...
- **Assertions**: `assert x > 0`. This is a promise that _must_ hold true.
...
- **`assume P`**: The verifier can _take it for granted_ that P is true. It is a filter that tells the verifier, "Only look at cases where P holds." If P is false, the path is ignored.
