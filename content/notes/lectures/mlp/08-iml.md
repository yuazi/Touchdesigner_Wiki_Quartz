...
3.  **The Uncertainty Trap**: Just because a model is "uncertain" doesn't mean it's the _right_ kind of uncertainty. It might just be looking at a low-quality or noisy image. **Deep Bayesian** methods try to distinguish between "model ignorance" and "noisy data" (Epistemic vs. Aleatoric uncertainty).
