...
- **Hierarchical Connection**: They can be viewed as a special form of hierarchical VAE with a fixed encoder. Modern systems like **Stable Diffusion** leverage this by using a VAE to compress images into a latent space first. → **[[/notes/lectures/mlp/09-vae|Generative AI & VAE L09]]**
