---
title: "07_deferred_shading  -  Deferred Shading, G-Buffers, and Visibility Buffers"
tags:
  - rtg
  - deferred-shading
  - g-buffer
...
[[notes/lectures/realtimegraphics/06_textures|Back: (y-06) Textures]] | [[notes/lectures/realtimegraphics/08_special_effects|Next: (y-08) Image-Space Special Effects]] | [[notes/lectures/realtimegraphics/index|RTG Index]]
...
![[pictures/realtimegraphics/07/L07_Pg-03.jpg]]

<p class="image-caption">L07_Pg-03: Forward rendering is intuitive and handles multiple materials easily but pays for overdraw.</p>
...
![[pictures/realtimegraphics/07/L07_Pg-04.jpg]]

<p class="image-caption">L07_Pg-04: Deferred rendering decouples shading from scene complexity by recording visible-surface attributes first, then lighting them.</p>
...
![[pictures/realtimegraphics/07/L07_Pg-05.jpg]]

<p class="image-caption">L07_Pg-05: The G-Buffer is a set of screen-sized textures written simultaneously through Multiple Render Targets.</p>
...
![[pictures/realtimegraphics/07/L07_Pg-08.jpg]]

<p class="image-caption">L07_Pg-08: A Blinn-Phong G-Buffer typically carries position, specular albedo, diffuse albedo, and normals.</p>
...
![[pictures/realtimegraphics/07/L07_Pg-09.jpg]]

<p class="image-caption">L07_Pg-09: Sponza rendered deferred: G-Buffer channels feed a single lighting pass to produce the final image.</p>
...
![[pictures/realtimegraphics/07/L07_Pg-10.jpg]]

<p class="image-caption">L07_Pg-10: The G-Buffer stores one depth per pixel, so transparent surfaces cannot be captured directly.</p>
...
![[pictures/realtimegraphics/07/L07_Pg-11.jpg]]

<p class="image-caption">L07_Pg-11: Deferred shading trades overdraw for memory, transparency, MSAA, and material-variety headaches.</p>
...
![[pictures/realtimegraphics/07/L07_Pg-14.jpg]]

<p class="image-caption">L07_Pg-14: Four 4K textures at 16 bytes per pixel is 2 GB of G-Buffer, and at 60 Hz that is 120 GB/s of bandwidth.</p>
...
![[pictures/realtimegraphics/07/L07_Pg-15.jpg]]

<p class="image-caption">L07_Pg-15: World-space position is reconstructed from depth and screen coordinates, saving one full G-Buffer texture.</p>
...
![[pictures/realtimegraphics/07/L07_Pg-17.jpg]]

<p class="image-caption">L07_Pg-17: Uncharted 4 packs PBR material data into two 16-bit RGBA textures, with extra textures only when materials demand them.</p>
...
![[pictures/realtimegraphics/07/L07_Pg-18.jpg]]

<p class="image-caption">L07_Pg-18: Deferred lighting splits the work into three passes: minimal G-Buffer, light buffer, then final shading.</p>
...
![[pictures/realtimegraphics/07/L07_Pg-21.jpg]]

<p class="image-caption">L07_Pg-21: Point lights are drawn as instanced spheres sized by intensity; only fragments inside the sphere are shaded for that light.</p>
...
![[pictures/realtimegraphics/07/L07_Pg-23.jpg]]

<p class="image-caption">L07_Pg-23: A Visibility Buffer stores only depth and primitive ID, then fetches attributes on demand during shading.</p>
...
![[pictures/realtimegraphics/07/L07_Pg-28.jpg]]

<p class="image-caption">L07_Pg-28: Storing only X and Y of a normalized normal lets the shader reconstruct Z, but the sign must be carried separately.</p>
...
![[pictures/realtimegraphics/07/L07_Pg-29.jpg]]

<p class="image-caption">L07_Pg-29: Best-fit normals trade unit length for quantization fit; reconstruction is just renormalization.</p>
